...
//       <section className="max-w-7xl mx-auto px-6 pt-14 pb-24 grid lg:grid-cols-2 gap-16 items-center">
...
//           <div className="relative bg-white/5 border border-white/10 backdrop-blur-2xl rounded-[2.5rem] p-7 shadow-2xl">

//             {/* Upload Area */}

//             <div className="border-2 border-dashed border-white/10 rounded-[2rem] p-10 text-center hover:border-blue-400/40 transition-all bg-[#111827]">
...
//                 <div className="mt-7 h-[320px] rounded-[2rem] border border-white/10 bg-[#111827] flex flex-col items-center justify-center text-gray-500">
//                   <ImageIcon size={50} />
...
//     {
//       title: "AI Caption",
//       text: "Lost somewhere between the city lights and midnight thoughts ✨",
//       icon: <Sparkles size={28} />
//     },

//     {
//       title: "Trending Hashtags",
//       text: "#Aesthetic #NightVibes #Photography #MoodyGrams #Urban",
//       icon: <Hash size={28} />
//     },

//     {
//       title: "Detected Mood",
//       text: "Dreamy • Cinematic • Chill",
//       icon: <Smile size={28} />
//     },
//   ].map((card, index) => (
...
//                 className="bg-white/5 border border-white/10 backdrop-blur-2xl rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300"
//               >
...
export default function App() {
  ...
  async function generateCaption() {
    ...
    try {
      ...
      // setHashtags(
      //   "#AI #Aesthetic #GenZ #Photography #Viral"
      // );

      // setMood(
      //   "Cinematic • Dreamy • Chill"
      // );
